export default {
  ...
  effects: {
    ...
    * setStorage(_, { select, put }) {
      ...
      const { cartData, sunPrice, numProduct } = stateArr.cart;
      const data = JSON.stringify(cartData);
      const _sunPrice = JSON.stringify(sunPrice);
      const _numProduct = JSON.stringify(numProduct);
